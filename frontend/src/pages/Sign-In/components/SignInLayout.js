            ...
            <div className="login-box no-margin login-center">
                ...
                <div className="login-box-body">
                    ...
                    <form onSubmit={props.onSubmit}>
                        <div className={`form-group ${props.onError ? "has-error" : "" } has-feedback`}>
                    ...
                    <div className="social-auth-links text-center">
                        <p>- OR -</p>
                        <a href="https://www.facebook.com" className="btn btn-block btn-social btn-facebook btn-flat"><i className="fa fa-facebook"></i> Sign in using Facebook</a>
                        <a href="https://www.google.com" className="btn btn-block btn-social btn-google btn-flat"><i className="fa fa-google-plus"></i> Sign in using Google+</a>
                    </div>
